...
/-!
# Minimal-counterexample wrapper for the no-`(3,3,1)` reduction

This module connects the complete local recolouring theorem to Section 4
edge-minimality.  It is separate from the local file to keep the common
minimality infrastructure acyclic.
-/
...
incident with two distinct 3-threads and a distinct 1-thread. -/
set_option maxHeartbeats 2400000 in
theorem IsEdgeMinimalBad.no_threeThreeOne_sectionFour
  ...
  exact longPair_no_threeThreeOne_of_smaller_good G hEligibleG.2.2
